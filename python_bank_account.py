class BankAccount:
    def __init__(self, first_name: str='xxxxxx' , last_name: str='xxxxxx', type: str='xxxxxx', number: int=0, balance: int=0, interestRate: int=0) -> None:
    ...
    def __str__(self)-> str: # prints account information
